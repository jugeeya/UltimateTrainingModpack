...
pub static STATUS_DISPLAY: LazyLock<HashMap<&'static str, i32>> = LazyLock::new(|| {
    HashMap::from_iter([
        (
...
static KIND_TO_CHAR: LazyLock<HashMap<i32, Character>> =
    LazyLock::new(|| character_pairs().iter().cloned().collect());
